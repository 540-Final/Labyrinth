...
module map (
	...
	input 		[9:0]	wrld_col,	// column address of world map location
	input 		[8:0]	wrld_row,	// row address of world map location	
	output		[7:0]	wrld_loc_info,	// map value for location [row_addr, col_addr]

		// interface to the video logic
	input 		[9:0]	vid_col,		// video logic column address
				[8:0]	vid_row,		// video logic row address
...
wire 	[8:0] 	wrld_row_halved, vid_row_halved;
wire    [7:0]   wrld_col_halved, vid_col_halved;

assign wrld_row_halved = wrld_row  >> 1;
assign wrld_col_halved = wrld_col  >> 1;
assign wrld_mem_addr = {wrld_row_halved, wrld_col_halved};

assign vid_row_halved = vid_row  >> 1;
assign vid_col_halved = vid_col  >> 1;
assign vid_mem_addr = {vid_row_halved, vid_col_halved};		
